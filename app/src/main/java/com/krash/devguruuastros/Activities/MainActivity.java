...
import com.krash.devguruuastros.Adapters.AstrologerAdapter;
import com.krash.devguruuastros.Adapters.SliderAdapter;
import com.krash.devguruuastros.MatMainActivity;
import com.krash.devguruuastros.Models.AstrologerModel;
import com.krash.devguruuastros.Models.SliderItem;
...
public class MainActivity extends AppCompatActivity {
    ...
    private LinearLayout matMain, chatMain, callMain, liveMain;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if(getIntent().getStringExtra("comesfrom").equalsIgnoreCase("userchat") || getIntent().getStringExtra("comesfrom").equalsIgnoreCase("afterCall"))
        {
            ...
            for (int x = 0; x < rvContainer.getChildCount(); x++) {
                ...
                rvContainer.getChildAt(x).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        spos = finalStarPos+1;
                       // Toast.makeText(MainActivity.this, "spos "+spos, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        ...
        userCS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:9205003125"));
...
//
        ...
        liveMain = findViewById(R.id.liveMain);
