...
//                updateStatus.put("chatOnline", "Offline");
                ...
                Intent i = new Intent(AstrologerMainActivity.this, UserCallActivity.class);
            ...
            firebaseDatabase.getReference().child("Astrologers").child(firebaseAuth.getUid())
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        earning = earning + Double.parseDouble(dataSnapshot.child("earning").getValue().toString());
                        if (dateFormat.format(date).equals(dataSnapshot.child("orderDate").getValue())) {
                            todayEarning = todayEarning + Double.parseDouble(dataSnapshot.child("earning").getValue().toString());
                        }
                    }
                    ...
                    try {
                       ...
                       // Toast.makeText(AstrologerMainActivity.this, ""+date1.compareTo(date2), Toast.LENGTH_SHORT).show();
                        ...
                        else
                        {
                            ...
                            largeDate[0] = SystemTools.getCurrent_date();
                        }
